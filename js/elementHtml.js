...
/** Customer HTML */
const customerLinkTpl = `<div class="customerLink"><i class="fa fa-link-thumb"></i></div>`;
const customerCheckedTpl = `<div class="customerChecked"><i class="fa fa-check-circle"></i></div>`;
...
const customerFormTpl = (customer) => {
  return `<div class="customerForm ${customer ? 'edit' : ''} d-none">
      <form>
        ...
        <div class="invalid-feedback province_id"></div>
        <div class="invalid-feedback district_id"></div>
        <div class="invalid-feedback ward_id"></div>
...
const customerInfo = (name, phone, address) =>
  `<div class="customerInfo d-none">
    <h5 class="customer__title">
      ${name}
      <i class="fa fa-icon-outline-setting editCustomer"></i>
    </h5>
...
const download_btn = `<div class="zaloapi_download_btn" style="position: relative;">
    <div class="msg-reaction-icon">
      <div class="default-react-icon-thumb">
        <i class="fa fa-outline-download f18 menu-icon"></i>
      </div>
    </div>
...
const copy_btn = `<div class="zaloapi_copy_btn" style="position: relative;">
    <div class="msg-reaction-icon">
      <div class="default-react-icon-thumb">
        <i class="fa fa-outline-copy f18 menu-icon"></i>
      </div>
    </div>
